# auth-semester-sparingly-docs

**Date:** 2026-07-13T233234Z
...
Document that /api/auth/semester endpoints should be used sparingly vs server-owned campus calendar
...
Grepped /api/auth/semester and /api/auth/active-semester. Documented use-sparingly guidance preferring the shared campus week calendar (server-owned time frame) in backend/API.md (mirrored to docs/dev/backend/api.md), docs/dev/README.md Campus Week section, auth controller/route comments, frontend getActiveSemester JSDoc, and TypeDoc reference pages for getActiveSemester.
