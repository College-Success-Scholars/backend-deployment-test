...
**Location:** [`frontend/components/marketing/`](../../../../../frontend/components/marketing/)  
...
|------|-------------|-------------|
| `landing-hero.tsx` | [source](../../../../../frontend/components/marketing/landing-hero.tsx) | Main hero section with headline, CTA, and background image |
| `landing-header.tsx` | [source](../../../../../frontend/components/marketing/landing-header.tsx) | Landing page navigation header |
| `landing-feature-cards.tsx` | [source](../../../../../frontend/components/marketing/landing-feature-cards.tsx) | Feature showcase cards describing app capabilities |
