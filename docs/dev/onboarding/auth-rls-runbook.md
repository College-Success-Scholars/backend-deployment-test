...
4. If only local: confirm env URLs/keys match the same Supabase project on frontend and backend.
5. Still stuck → [Ask / don’t touch](ask-and-dont-touch.md) contacts with the request URL + status + whether you were acting as a persona.
